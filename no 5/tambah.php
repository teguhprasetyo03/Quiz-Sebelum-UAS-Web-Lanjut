      ...
      <div class="card-body">
        <form action="" method="post" role="form">
          <div class="form-group">
            ...
            <input type="text" name="kode_laptop" required="" class="form-control">
          </div>
          <div class="form-group">
        ...
        if (isset($_POST['submit'])) {
          ...
          $datas = mysqli_query($koneksi, "insert into tb_laptop (kode_laptop,prosesor,tahun_pembuatan,warna,harga,merk,ukuran) values('$kode', '$prosesor', '$tahun', '$warna', '$harga', '$merk', '$ukuran')") or die(mysqli_error($koneksi));
          //id barang tidak dimasukkan, karena sudah menggunakan AUTO_INCREMENT, id akan otomatis

          //ini untuk menampilkan alert berhasil dan redirect ke halaman index
          echo "<script>alert('data berhasil disimpan.');window.location='tampil_laptop.php';</script>";
        }
        ?>
      </div>
    </div>
